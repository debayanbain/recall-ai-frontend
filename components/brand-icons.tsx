...
/** Telegram's paper-plane glyph, in the official single-colour blue. */
export function TelegramMark({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden focusable="false">
      ...
      <path
        fill="#fff"
        d="M5.491 11.74c3.5-1.525 5.834-2.53 7.001-3.016 3.334-1.386 4.027-1.627 4.479-1.635.099-.002.321.023.465.14a.506.506 0 01.17.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.5 1.201-.82 1.23-.697.065-1.226-.46-1.901-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.209.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.062 3.345-.479.329-.913.489-1.302.481-.428-.009-1.252-.242-1.865-.44-.752-.245-1.349-.374-1.297-.79.027-.216.325-.437.893-.663z"
      />
    </svg>
  );
}
