...
const flatCard =
  "gap-0 rounded-2xl border border-border py-0 shadow-none ring-0";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mb-8 text-center sm:mb-10">
          ...
          <p className="mx-auto mt-3 max-w-xl text-[14px] text-muted-foreground">
            The full second brain — capture, vault, spaces, ask and
            Telegram-style chat — designed for thumb-first interaction.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-start justify-center gap-6 sm:gap-8">
          ...
          <Phone label="Capture sheet">
            <PhoneCapture />
          </Phone>
          <Phone label="Space detail">
            <PhoneSpace />
          </Phone>
          <Phone label="Ask Recall">
            <PhoneChat />
          </Phone>
          <Phone label="Telegram capture">
            <PhoneTelegram />
          </Phone>
        </div>
      </div>
...
function PhoneSpace() {
  ...
  return (
    <div className="relative h-full bg-background">
      <StatusBar />
      <div
        className={`relative h-44 overflow-hidden bg-linear-to-br ${s.gradient}`}
      >
      ...
      <div className="-mt-6 px-5">
        <Card className={flatCard}>
          <CardContent className="p-4">
            ...
            <div className="mt-1 font-display text-[24px] leading-tight tracking-tight">
              {s.title}
            </div>
            ...
            <Card key={m.id} className={flatCard}>
              <CardContent className="p-3">
                <div
                  ...
                  style={{ backgroundImage: m.accent }}
                />
                <div className="mt-2 line-clamp-1 text-[12.5px] font-semibold">
                  {m.title}
                </div>
  ...
  return (
    <div className="relative h-full bg-background">
      ...
      <div className="space-y-3 px-4 py-4">
        ...
        <Card
          className={`${flatCard} max-w-[90%] rounded-tl-md text-[13px] text-foreground/85`}
        >
          <CardContent className="p-3">
            ...
            <div className="mt-2 text-[12.5px] leading-relaxed">
              You saved it inside{" "}
              <span className="font-medium">Startup Ideas</span> as a voice
              note, and it&rsquo;s connected to your Lean Startup notes.
            </div>
            <div className="mt-2.5 space-y-2">
              {memories.slice(1, 3).map((m) => (
                <div
                  key={m.id}
                  className="flex gap-2 rounded-xl border border-border bg-secondary/40 p-2"
                >
                  <div
                  ...
                  />
                  <div className="min-w-0">
                    <div className="line-clamp-1 text-[11.5px] font-semibold">
                      {m.title}
                    </div>
  ...
  return (
    <div className="relative h-full bg-secondary/30">
      ...
      <div className="space-y-2.5 px-3 py-4">
        <Card
          className={`${flatCard} max-w-[80%] rounded-tl-md text-[12.5px] text-foreground/85`}
        >
